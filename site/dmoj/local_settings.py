...
# ALLOWED_HOSTS = ['192.168.130.226', 'localhost']
...
STATIC_ROOT = '/home/hauvan/WebProject/database/static'
...
MEDIA_ROOT = '/home/hauvan/WebProject/database/media'

## Problem data settings.
# This is the directory where all the problem data are stored.
# Change this to somewhere more permanent.
DMOJ_PROBLEM_DATA_ROOT = '/home/hauvan/WebProject/database/problems/'
